          ...
          child: Row(
            ...
            children: [
              _buildNavItem(
                ...
                label: 'Home',
                index: 0,
                onTap: () => _navigateTo('/student-home'),
              ),
              _buildNavItem(
                icon: Icons.search_rounded,
                label: 'Search',
                index: 1,
                onTap: () => _navigateTo('/student-search'),
              ),
              _buildNavItem(
                icon: Icons.favorite_rounded,
                label: 'Saved',
                index: 2,
                onTap: () => _navigateTo('/student-saved'),
              ),
              _buildNavItem(
                icon: Icons.chat_bubble_rounded,
                label: 'Messages',
                index: 3,
                onTap: () => _navigateTo('/student-messages'),
              ),
              _buildNavItem(
                icon: Icons.person_rounded,
                label: 'Profile',
                index: 4,
                onTap: () => _navigateTo('/student-profile'),
              ),
            ],
          ),
        ),
